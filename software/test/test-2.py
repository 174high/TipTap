...
robot = p.loadURDF("test-my-first-2.urdf", StartPos, StartOrientation)
p.setRealTimeSimulation(1) # real-time instead of step control


while 1:

# lower="-0.305432619099" upper="0.343829862643"  according to urdf file , the number of position should be from -0.3 to -0.34  

    p.setJointMotorControl2(
                robot, 0, p.POSITION_CONTROL,
                targetPosition=-0.3, force=10)
